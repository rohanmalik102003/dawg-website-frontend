      ...
      if (isLogin) {
        ...
        await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/users/`, {
          ...
          body: JSON.stringify({
            ...
            display_name: data.display_name || data.username || data.email.split('@')[0]
          })
        })
      ...
      <div className="bg-white rounded-lg max-w-md w-full p-6 relative">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 mt-2">
            {isLogin ? 'Sign in to your account' : 'Join the DoIt community'}
          </p>
        </div>
        ...
        <div className="mt-4">
          ...
          <button
            ...
            disabled={loading}
            className="mt-4 w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
